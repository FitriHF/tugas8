package id.ac.amikom.apppanas.ui.base
...
import id.ac.amikom.apppanas.BR
import java.lang.reflect.TypeVariable

abstract class BaseAdaper<T>(@field:LayoutRes private var layoutId: Int) : RecyclerView.Adapter<BaseAdaper<T>.ViewHolder>(), BindableAdapter<List<T>> {
